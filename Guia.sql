...
insert into Modelo (descripcion, marca_id) values ("Clase G", 2);
insert into Modelo (descripcion, marca_id) values ("4X4", 1);
...
insert into Categoria (descripcion) values ("Basica");
